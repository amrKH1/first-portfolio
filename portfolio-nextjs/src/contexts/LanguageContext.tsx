...
const translations = {
  en: {
    ...
    'hero.description': 'I create exceptional digital experiences through innovative web applications and mobile solutions. Passionate about clean code, user experience, and cutting-edge technologies to deliver outstanding results.',
    'hero.badge1': '5+ Years Experience',
    ...
    'about.subtitle': 'Passionate developer with a love for creating digital solutions',
    'about.description1': 'With over 5 years of experience in web and mobile development, I specialize in creating scalable, user-friendly applications that solve real-world problems. My expertise spans across frontend and backend technologies, with a particular focus on modern frameworks and best practices.',
    'about.description2': 'I believe in writing clean, maintainable code and staying up-to-date with the latest industry trends. When I\'m not coding, you can find me contributing to open-source projects, mentoring junior developers, or exploring new technologies.',
    ...
    'projects.subtitle': 'A showcase of my recent work and achievements',
    'projects.project1.title': 'E-Commerce Platform',
    'projects.project1.description': 'Full-stack e-commerce solution with React frontend, Node.js backend, and integrated payment processing. Features include user authentication, product management, and real-time inventory tracking.',
    'projects.project2.title': 'Task Management Mobile App',
    'projects.project2.description': 'Cross-platform mobile application built with React Native. Features include task creation, team collaboration, push notifications, and offline synchronization capabilities.',
    'projects.project3.title': 'Real-time Analytics Dashboard',
    'projects.project3.description': 'Interactive dashboard for data visualization and analytics. Built with Vue.js and D3.js, featuring real-time data updates, customizable charts, and export functionality.',
    'projects.project4.title': 'Social Media Platform',
    'projects.project4.description': 'Full-featured social media application with user profiles, posts, comments, real-time messaging, and content moderation. Built with modern web technologies and scalable architecture.',
    'projects.project5.title': 'Fitness Tracking App',
    'projects.project5.description': 'Native iOS and Android fitness application with workout tracking, progress analytics, social features, and integration with wearable devices. Built using Flutter for cross-platform compatibility.',
    'projects.project6.title': 'AI-Powered Chatbot Platform',
    'projects.project6.description': 'Intelligent chatbot platform with natural language processing, machine learning capabilities, and multi-channel deployment. Features admin dashboard and analytics for conversation insights.',
    ...
    'experience.job1.description': 'Lead development of enterprise web applications and mobile solutions. Manage a team of 5 developers and collaborate with cross-functional teams to deliver high-quality products. Implemented CI/CD pipelines and improved deployment efficiency by 40%.',
    ...
    'experience.job2.description': 'Developed and maintained multiple client projects including e-commerce platforms, content management systems, and mobile applications. Collaborated with designers and product managers to create user-friendly interfaces and optimize user experience.',
    'experience.job3.period': '2019 - 2020',
    'experience.job3.title': 'Frontend Developer',
    'experience.job3.company': 'StartupXYZ',
    'experience.job3.description': 'Focused on creating responsive and interactive user interfaces for web applications. Worked closely with UX/UI designers to implement pixel-perfect designs and ensure cross-browser compatibility. Contributed to the company\'s design system and component library.',
    'experience.job4.period': '2018 - 2019',
    'experience.job4.title': 'Junior Web Developer',
    'experience.job4.company': 'WebDev Agency',
    'experience.job4.description': 'Started my professional journey as a junior developer, working on various client websites and learning industry best practices. Gained experience in both frontend and backend technologies while contributing to team projects and maintaining existing codebases.',
